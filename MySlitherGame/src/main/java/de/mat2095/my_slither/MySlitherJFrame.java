    ...
    void onOpen() {
        switch (status) {
            case CONNECTING:
                ...
                // Snake.getSelectedIndex = Skin Type (Number)
                //System.out.println("Init requested Data " + snake.getSelectedIndex() + "//" + name.getText());
                break;
            case DISCONNECTING:
                disconnect();
                break;
