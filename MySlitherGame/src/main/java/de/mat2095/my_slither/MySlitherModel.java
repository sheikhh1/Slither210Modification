...
class MySlitherModel {
    ...
    void addSnake(int snakeID, String name, Color snakeCol, double x, double y, double wang, double ang, double sp, double fam, Deque<SnakeBodyPart> body) {
        synchronized (view.modelLock) {
            Snake newSnake = new Snake(snakeID, name, snakeCol , x, y, wang, ang, sp, fam, body, this);
            if (snake == null) {
                snake = newSnake;
            }
